...
### Versioning
- `metadata.txt` : `version=0.1` → `0.2.0`, champ `changelog` renseigné,
  compat Qt5 (QGIS 3.x) + Qt6 (QGIS 3.30+ builds Qt6 / QGIS 4) via `qgis.PyQt`.
- Tag GitHub : `v0.2.0`
- Dépôt plugins QGIS : uploader `gsm_cover_builder-0.2.0.zip`
  (dossier top-level `GSM_Cover_Builder/`, 10 fichiers) avec le
  contenu de la section `0.2.0` ci-dessus comme notes de version.
